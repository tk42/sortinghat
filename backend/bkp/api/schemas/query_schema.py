...
from api.scalars.stickynotes_scalar import StickyNotes

from api.resolvers.stickynote_resolver import get_stickynote, get_stickynotes
from api.resolvers.user_resolver import get_user, get_users
from api.scalars.user_scalar import User
